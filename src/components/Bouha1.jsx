  ...
  const postData = async () => {
    ...
    try {
      result = await axios.post(
        'http://127.0.0.1:8000/users/Bouha1/',
        formData,
        {
          headers: {
    ...
    <>
      {showResult === false && (
        ...
        >
          ...
          >
            <p className={styles.sectionSubText}>Do you need a personalised</p>
            <h2 className={styles.sectionHeadText}>Recommendation</h2>
...
export default SectionWrapper(Bouha1, 'Bouha1');
